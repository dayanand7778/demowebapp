...
<body>
  <div class="jumbojump" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h2 class="text-center">Welcome to DARing:- Anand,DAYA,giri Jai and Chaitali on behalf of Infinito Solutions</h2>
